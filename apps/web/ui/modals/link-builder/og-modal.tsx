...
import { ImageIcon, LoadingCircle, Magic } from "@dub/ui/icons";
                  ...
                  <Popover
                    content={
                      <StockSearch
                        ...
                        setOpenPopover={setOpenImagePopover}
                      />
                    }
                    openPopover={openImagePopover}
                    setOpenPopover={setOpenImagePopover}
                  >
                    <div>
                      <ButtonTooltip
                        onClick={() => setOpenImagePopover(true)}
                        tooltipProps={{
                          content: "Choose an image from local library",
                        }}
                      >
